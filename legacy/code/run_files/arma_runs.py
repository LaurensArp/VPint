...
experiment_name = "ARMA_Seoul_Taipei"
shapefile_path_train = seoul_dict['shp']
bbox_train_bl = seoul_dict['bbox_bl']
bbox_train_tr = seoul_dict['bbox_tr']
...
hidden_proportion_test = 0.5 # This one is kind of hacky, it gets changed in the loop anyway,
                             # but this way I can use the same preprocessing function for both

# Create result files, if they do not exist already
...
for i in range(0,num_runs):
    ...
    for hidden_proportion in proportions:
        ...
        while True:
            try:
                # This catch-all try-except block is just for random computing cluster
                # issues, should be fine to use the code without it
...
experiment_name = "ARMA_Seoul_Daegu"
shapefile_path_train = seoul_dict['shp']
bbox_train_bl = seoul_dict['bbox_bl']
bbox_train_tr = seoul_dict['bbox_tr']
...
experiment_name = "ARMA_Taichung_Taipei"
